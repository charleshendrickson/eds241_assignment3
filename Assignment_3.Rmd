...
**The estimated average treatment effect of smoking on birthweight using the exact matching estimator and its linear regression analogue is -224.2583 grams for the ATE and -222.589 grams for ATT.**
...
```{r}
glm(formula = , family = binomial(), smoking_data_dummy)
```
